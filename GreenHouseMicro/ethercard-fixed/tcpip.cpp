...
void EtherCard::browseUrl ( char *urlbuf,  char *urlbuf_varpart,  char *hoststr, void (*callback)(uint8_t,uint16_t,uint16_t)) {
    browseUrl(urlbuf, urlbuf_varpart, hoststr, ("Accept: text/html"), callback);
}

void EtherCard::browseUrl ( char *urlbuf,  char *urlbuf_varpart,  char *hoststr,  char *additionalheaderline, void (*callback)(uint8_t,uint16_t,uint16_t)) {
...
void EtherCard::httpPost (char *urlbuf, char *hoststr, char *additionalheaderline, char *postval, void (*callback)(uint8_t,uint16_t,uint16_t)) {
    client_urlbuf = urlbuf;
    client_hoststr = hoststr;
    client_additionalheaderline = additionalheaderline;
